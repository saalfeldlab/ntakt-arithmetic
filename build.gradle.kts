...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("ntakt-arithmetic")
                url.set("https://github.com/saalfeldlab/ntakt-arithmetic")
                ...
                scm {
                    connection.set("scm:git:git://github.com/saalfeldlab/ntakt-arithmetic")
                    developerConnection.set("scm:git:git@github.com:saalfeldlab/ntakt-arithmetic")
                    tag.set("HEAD")
                    url.set("https://github.com/saalfeldlab/ntakt-arithmetic")
                }
                ciManagement {
                    system.set("Travis CI")
                    url.set("https://travis-ci.com/saalfeldlab/ntakt-arithmetic")
                }
                repositories {
